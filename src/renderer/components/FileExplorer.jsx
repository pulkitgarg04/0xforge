    ...
    <div>
      ...
      {item.isDirectory && expanded && (
        <div>
          {loading && (
            <div
              className="text-xs text-forge-text-dim py-1"
          ...
          {!loading && children.length === 0 && (
            <div
              className="text-xs text-forge-text-dim py-1 italic"
              style={{ paddingLeft: `${(depth + 1) * 16 + 8}px` }}
            >
              Empty
            </div>
...
export default function FileExplorer({
  ...
  useEffect(() => {
    loadRoot();
  }, [loadRoot, refreshKey, refreshVersion]);
          ...
          <div className="px-3 mb-1">
            <div className="flex items-center gap-1.5 px-2">
              ...
              <input
                ...
                placeholder={
                  newItemType === "file" ? "filename.cpp" : "folder name"
                }
